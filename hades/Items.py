...
items_table_event: Dict[str, ItemData] = {
    ...
    "MegVictorySwordWeapon": ItemData(hades_event_base_item_id+40, True, True),
    "LernieVictorySwordWeapon" : ItemData(hades_event_base_item_id+41, True, True),
    "BrosVictorySwordWeapon": ItemData(hades_event_base_item_id+42, True, True),
    "HadesVictoryBowWeapon": ItemData(hades_event_base_item_id+43, True, True),
    "MegVictoryBowWeapon": ItemData(hades_event_base_item_id+44, True, True),
    "LernieVictoryBowWeapon": ItemData(hades_event_base_item_id+45, True, True),
    "BrosVictoryBowWeapon" : ItemData(hades_event_base_item_id+46, True, True),
    "HadesVictorySpearWeapon" : ItemData(hades_event_base_item_id+47, True, True),
    "MegVictorySpearWeapon": ItemData(hades_event_base_item_id+48, True, True),
    "LernieVictorySpearWeapon": ItemData(hades_event_base_item_id+49, True, True),
    "BrosVictorySpearWeapon": ItemData(hades_event_base_item_id+50, True, True),
    "HadesVictoryShieldWeapon": ItemData(hades_event_base_item_id+51, True, True),
    "MegVictoryShieldWeapon": ItemData(hades_event_base_item_id+52, True, True),
    "LernieVictoryShieldWeapon": ItemData(hades_event_base_item_id+53, True, True),
    "BrosVictoryShieldWeapon": ItemData(hades_event_base_item_id+54, True, True),
    "HadesVictoryFistWeapon": ItemData(hades_event_base_item_id+55, True, True),
    "MegVictoryFistWeapon": ItemData(hades_event_base_item_id+56, True, True),
    "LernieVictoryFistWeapon": ItemData(hades_event_base_item_id+57, True, True),
    "BrosVictoryFistWeapon": ItemData(hades_event_base_item_id+58, True, True),
    "HadesVictoryGunWeapon": ItemData(hades_event_base_item_id+59, True, True),
    "MegVictoryGunWeapon": ItemData(hades_event_base_item_id+60, True, True),
    "LernieVictoryGunWeapon": ItemData(hades_event_base_item_id+61, True, True),
    "BrosVictoryGunWeapon": ItemData(hades_event_base_item_id+62, True, True),
}
