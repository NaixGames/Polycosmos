...
location_table_fates = {
    ...
    "A Place of Reverly" : max_number_room_checks + 94,
...
location_table_fates_events = {
    ...
    "Musician and Muse" : None,
    "End to Torment" : None,
    "Divided by Death" : None,
    "Eternal Rest" : None,
    "A Place of Reverly" : None,
    "Amusing Chaos" : None,
    "Sea-God's Spite" : None,
    "War-God's Bloodlust" : None, 
    "A Friendly Wager" : None, 
    "The Holy Liege" : None,
    "The Fated Saint of War" : None,
    "The Preserver's Avatar" : None,
    "The Dragon's Rival" : None,
    "The God-like King" : None,
    "The Dawn Bringer" : None,
    "The Gift of Song" : None,
}
